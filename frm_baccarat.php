  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="row justify-content-center">
        ...
        <h1 class="text-center" id="showr1">บาคาร่า</h1>
      ...
      <td><h1 class="text-center" id="showr" >กรุณากดคำสั่งสุ่มแพทเทิ้ลเพื่อเริ่มเล่น!!!</h1></td>
        ...
        <div class="row justify-content-center">
          <input id="b1" disabled type="button" value="   P=ผู้เล่น   " class="btn btn-primary " onclick="checkp()">
          &nbsp;&nbsp;&nbsp;
          <input id="b2" disabled type="button" value=" เสมอ " class="btn btn-success  " onclick="checkt()">
          &nbsp;&nbsp;&nbsp;
          <input id="b3" disabled type="button" value=" B=เจ้ามือ " class="btn btn-danger  " onclick="checkb()">
        </div>
        <div class="row justify-content-center">
	...
	<form id="form1" name="form1" method="get" action="edit_ba.php">		
