...
<?php
	...
	if ( $x1 != null && $x2 != null && $x3 != null && $x4 != null && $x5 != null && $x6 != null && $x7 != null && $x8 != null && $x9 != null && $x10 != null && $x11 != null && $x12 != null ) {
		...
		if ( $conn1->query( $sql1 ) === TRUE ) {
			...
			header('Location: frm_fantan.php');
		} else {
...
<div class="row">
  <div class="col-12">
    ...
    <nav>
      <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist"> <a class="nav-item nav-link active text-dark bg-warning" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">คู่-คี่</a> <a class="nav-item nav-link text-dark bg-warning" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">1-2และ3-4</a> <a class="nav-item nav-link text-dark bg-warning" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">4-1และ2-3</a> </div>
    </nav>
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
        <h1 class="text-center" id="showr1">กำถั่ว</h1>
      ...
      <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
        <h1 class="text-center" id="ashowr1">กำถั่ว</h1>
        <table class="table table-secondary">
        <tr>
      <td><h1 class="text-center" id="ashowr" >กรุณากดคำสั่งสุ่มแพทเทิ้ลเพื่อเริ่มเล่น!!!</h1></td>
        ...
        <div class="row justify-content-center">
          <input id="b11" disabled type="button" value="   1-2   " class="btn btn-info btn-lg" onclick="acheckp()">
          &nbsp;&nbsp;&nbsp;
          <input id="b31" disabled type="button" value=" 3-4 " class="btn btn-warning  btn-lg" onclick="acheckb()">
        </div>
      </div>
      <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
        <h1 class="text-center" id="bshowr1">กำถั่ว</h1>
         <table class="table table-secondary">
        <tr>
      <td><h1 class="text-center" id="bshowr" >กรุณากดคำสั่งสุ่มแพทเทิ้ลเพื่อเริ่มเล่น!!!</h1></td>
        ...
        <div class="row justify-content-center">
          <input id="b111" disabled type="button" value="   4-1   " class="btn btn-dark btn-lg" onclick="bcheckp()">
          &nbsp;&nbsp;&nbsp;
          <input id="b311" disabled type="button" value=" 2-3 " class="btn btn-danger  btn-lg" onclick="bcheckb()">
        </div>
      </div>
      <div class="">
	...
	<form id="form1" name="form1" method="get" action="edit_fan.php">		
