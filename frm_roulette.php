...
<?php
	...
	if ( $x1 != null && $x2 != null && $x3 != null && $x4 != null && $x5 != null && $x6 != null && $x7 != null && $x8 != null && $x9 != null && $x10 != null && $x11 != null && $x12 != null ) {
		...
		if ( $conn1->query( $sql1 ) === TRUE ) {
			...
			header('Location: frm_roulette.php');
		} else {
...
function random(){
	...
	document.getElementById("b211").disabled = false;
      ...
      if(bcoins_1 == 1){
        document.getElementById("bcoins_1").innerHTML = '<font color="'+color41+'" size="3">'+show41+'</font>';	
		 document.getElementById("bshowr").innerHTML = '<font color="'+color41+'" size="7">'+show41+'</font>';	
		  document.getElementById("bshowr1").innerHTML = '<font " size="3">ไม้ที่ 1 ลง '+<?php echo($x1)  ?>+' บาท กันศูนย์  '+<?php echo($o1)  ?>+' บาท</font>';
        bc_1 = show41;
      }else{
...
function bcheckp(){
	...
	if(suma2 == 1){
      ...
      if(bc_2 == show41){
		...
		document.getElementById("bshowr1").innerHTML = '<font  size="3">ไม้ที่ 2 ลง '+<?php echo($x2)  ?>+' บาท กันศูนย์  '+<?php echo($o2)  ?>+' บาท</font>';
		vloss = vloss+<?php echo($l1)?>;
		sumwin = vwin-vloss;
		document.getElementById("showwin1").innerHTML = '<font>'+sumwin+' บาท</font>';
		vloss = 0;
      ...
      if(bc_3 == show41){
		...
		document.getElementById("bshowr1").innerHTML = '<font  size="3">ไม้ที่ 3 ลง '+<?php echo($x3)  ?>+' บาท กันศูนย์  '+<?php echo($o3)  ?>+' บาท</font>';
		vloss = vloss+<?php echo($l2)?>;
		sumwin = vwin-vloss;
		document.getElementById("showwin1").innerHTML = '<font>'+sumwin+' บาท</font>';
		vloss = 0;
      ...
      if(bc_4 == show41){
		...
		document.getElementById("bshowr1").innerHTML = '<font  size="3">ไม้ที่ 4 ลง '+<?php echo($x4)  ?>+' บาท กันศูนย์  '+<?php echo($o4)  ?>+' บาท</font>';
		vloss = vloss+<?php echo($l3)?>;
		sumwin = vwin-vloss;
		document.getElementById("showwin1").innerHTML = '<font>'+sumwin+' บาท</font>';
		vloss = 0;
      ...
      if(bc_5 == show41){
		...
		document.getElementById("bshowr1").innerHTML = '<font  size="3">ไม้ที่ 5 ลง '+<?php echo($x5)  ?>+' บาท กันศูนย์  '+<?php echo($o5)  ?>+' บาท</font>';
		vloss = vloss+<?php echo($l4)?>;
		sumwin = vwin-vloss;
		document.getElementById("showwin1").innerHTML = '<font>'+sumwin+' บาท</font>';
		vloss = 0;
      ...
      if(bc_6 == show41){
		...
		document.getElementById("bshowr1").innerHTML = '<font  size="3">ไม้ที่ 6 ลง '+<?php echo($x6)  ?>+' บาท กันศูนย์  '+<?php echo($o6)  ?>+' บาท</font>';
		vloss = vloss+<?php echo($l5)?>;
		sumwin = vwin-vloss;
		document.getElementById("showwin1").innerHTML = '<font>'+sumwin+' บาท</font>';
		vloss = 0;
      ...
      if(bc_7 == show41){
		...
		document.getElementById("bshowr1").innerHTML = '<font  size="3">ไม้ที่ 7 ลง '+<?php echo($x7)  ?>+' บาท กันศูนย์  '+<?php echo($o7)  ?>+' บาท</font>';losss++;
		vloss = vloss+<?php echo($l6)?>;
		sumwin = vwin-vloss;
		document.getElementById("showwin1").innerHTML = '<font>'+sumwin+' บาท</font>';
		vloss = 0;
      ...
      if(bc_8 == show41){
		...
		document.getElementById("bshowr1").innerHTML = '<font  size="3">ไม้ที่ 8 ลง '+<?php echo($x8)  ?>+' บาท กันศูนย์  '+<?php echo($o8)  ?>+' บาท</font>';losss++;
		vloss = vloss+<?php echo($l7)?>;
		sumwin = vwin-vloss;
		document.getElementById("showwin1").innerHTML = '<font>'+sumwin+' บาท</font>';
		vloss = 0;
      ...
      if(bc_99 == show41){
		...
		document.getElementById("bshowr1").innerHTML = '<font  size="3">ไม้ที่ 9 ลง '+<?php echo($x9)  ?>+' บาท กันศูนย์  '+<?php echo($o9)  ?>+' บาท</font>';losss++;
		vloss = vloss+<?php echo($l8)?>;
		sumwin = vwin-vloss;
		document.getElementById("showwin1").innerHTML = '<font>'+sumwin+' บาท</font>';
		vloss = 0;
      ...
      if(bc_10 == show41){
		...
		document.getElementById("bshowr1").innerHTML = '<font  size="3">ไม้ที่ 10 ลง '+<?php echo($x10)  ?>+' บาท กันศูนย์  '+<?php echo($o10)  ?>+' บาท</font>';losss++;
		vloss = vloss+<?php echo($l9)?>;
		sumwin = vwin-vloss;
		document.getElementById("showwin1").innerHTML = '<font>'+sumwin+' บาท</font>';
		vloss = 0;
      ...
      if(bc_11 == show41){
		...
		document.getElementById("bshowr1").innerHTML = '<font  size="3">ไม้ที่ 11 ลง '+<?php echo($x11)  ?>+' บาท กันศูนย์  '+<?php echo($o11)  ?>+' บาท</font>';losss++;
		vloss = vloss+<?php echo($l10)?>;
		sumwin = vwin-vloss;
		document.getElementById("showwin1").innerHTML = '<font>'+sumwin+' บาท</font>';
		vloss = 0;
      ...
      if(bc_12 == show41){
		...
		document.getElementById("bshowr1").innerHTML = '<font  size="3">ไม้ที่ 12 ลง '+<?php echo($x12)  ?>+' บาท กันศูนย์  '+<?php echo($o12)  ?>+' บาท</font>';losss++;
		vloss = vloss+<?php echo($l11)?>;
		sumwin = vwin-vloss;
		document.getElementById("showwin1").innerHTML = '<font>'+sumwin+' บาท</font>';
		vloss = 0;
...
<div class="row">
  <div class="col-12">
    ...
    <nav>
      <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist"> <a class="nav-item nav-link active text-dark bg-warning" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">แดง-ดำ</a> <a class="nav-item nav-link text-dark bg-warning" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">คู่-คี่</a> <a class="nav-item nav-link text-dark bg-warning" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">สูง-ต่ำ</a> </div>
    </nav>
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
        <h1 class="text-center" id="showr1">รูเล็ต</h1>
      ...
      <td><h1 class="text-center" id="showr" >กรุณากดคำสั่งสุ่มแพทเทิ้ลเพื่อเริ่มเล่น!!!</h1></td>
        ...
        <div class="row justify-content-center">
          <input id="b1" disabled type="button" value="   R=แดง   " class="btn btn-danger" onclick="checkp()">    
          &nbsp;&nbsp;&nbsp; 
          <input  id="b2" disabled  type="button" value=" 0=ศูนย์ " class="btn btn-success" onclick="checkt()">       
          &nbsp;&nbsp;&nbsp;
          <input  id="b3" disabled  type="button" value=" B=ดำ " class="btn btn-dark" onclick="checkb()">         
        </div>        
      </div>
      <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
        <h1 class="text-center" id="ashowr1">รูเล็ต</h1>
        <table class="table table-secondary">
        <tr>
      <td><h1 class="text-center" id="ashowr" >กรุณากดคำสั่งสุ่มแพทเทิ้ลเพื่อเริ่มเล่น!!!</h1></td>
        ...
        <div class="row justify-content-center">
          ...
          &nbsp;&nbsp;&nbsp; 
          <input  id="b21" disabled  type="button" value=" 0=ศูนย์ " class="btn btn-success" onclick="acheckt()">       
          &nbsp;&nbsp;&nbsp;
          <input id="b31" disabled type="button" value=" O=คี่ " class="btn btn-danger" onclick="acheckb()">         
        </div>         
      </div>
      <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
        <h1 class="text-center" id="bshowr1">รูเล็ต</h1>
         <table class="table table-secondary">
        <tr>
      <td><h1 class="text-center" id="bshowr" >กรุณากดคำสั่งสุ่มแพทเทิ้ลเพื่อเริ่มเล่น!!!</h1></td>
        ...
        <div class="row justify-content-center">
          <input id="b111" disabled type="button" value="   H=สูง   " class="btn btn-info" onclick="bcheckp()">   
          &nbsp;&nbsp;&nbsp; 
          <input  id="b211" disabled  type="button" value=" 0=ศูนย์ " class="btn btn-success" onclick="checkt()">        
          &nbsp;&nbsp;&nbsp;
          <input id="b311" disabled type="button" value=" L=ต่ำ " class="btn btn-warning" onclick="bcheckb()">          
        </div>        
      </div>
      <div class="">
	...
	<form id="form1" name="form1" method="get" action="edit_roulette.php">		
		...
		<table class="table table-sm">
			<thead class="thead-dark">
				<tr>
					<th scope="col">ไม้</th>
					<th scope="col">ทุน</th>
					<th scope="col">ศูนย์</th>
					<th scope="col">ขาดทุน</th>
					<th scope="col">กำไร</th>
					<th scope="col">กำไรศูนย์</th>
				</tr>
			</thead>
			<tbody>
				<tr>
