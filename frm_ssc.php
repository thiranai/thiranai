...
<?php
	...
	if ( $x1 != null && $x2 != null && $x3 != null && $x4 != null && $x5 != null && $x6 != null && $x7 != null && $x8 != null && $x9 != null && $x10 != null && $x11 != null && $x12 != null ) {
		...
		VALUES ('" . $c_id . "','" . $u_user . "','" . $m_wood . "','10','20','50','100','200','410','840','1710','3490','7125','14547','29700')";
...
<div class="row">
  <div class="col-12">
    ...
    <nav>
      <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist"> <a class="nav-item nav-link active text-dark bg-warning" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">คู่-คี่</a> <a class="nav-item nav-link text-dark bg-warning" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">เล็ก-ใหญ่</a>
    </nav>
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
        <h1 class="text-center" id="showr1">SSC ค่ายLetou</h1>
      ...
      <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
        <h1 class="text-center" id="ashowr1">SSC ค่ายLetou</h1>
        <table class="table table-secondary">
        <tr>
	...
	<form id="form1" name="form1" method="get" action="edit_ssc.php">		
